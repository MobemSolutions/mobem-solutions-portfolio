...
export const richTextComponents: PortableTextComponents = {
  types: {
    ...
    callout: ({ value }) => {
      if (value.type === "cta") {
        return (
          <div className="my-10 border border-accent/30 bg-accent/5 p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center gap-4">
            ...
            {value.ctaLabel && (
              <Link
                ...
                className="inline-flex items-center gap-2 bg-accent text-accent-foreground px-5 py-2.5 font-semibold text-sm hover:bg-accent/90 transition-colors shrink-0"
              >
                {value.ctaLabel}
      ...
      if (value.type === "warning") {
        return (
          <div className="my-6 flex gap-3 border border-yellow-500/30 bg-yellow-500/5 p-4">
      ...
      return (
        <div className="my-6 flex gap-3 border border-blue-500/30 bg-blue-500/5 p-4">
  ...
  block: {
    ...
    blockquote: ({ children }) => (
      <blockquote className="my-8 border-l border-accent pl-6 italic text-foreground text-lg font-medium">
        {children}
      </blockquote>
    ),
  },
